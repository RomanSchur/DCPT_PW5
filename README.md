...
В ролі базової моделі виступає логістична регресія, яка на кожній ітерації тренується на поточному наборі ознак та обчислює їхні вагові коефіцієнти. Алгоритм працює за принципом зворотного виключення: він ранжує ознаки за їхньою важливістю та крок за кроком видаляє найменш значущі з них. Використанню StratifiedKFold на 5 фолдів, дозволило процесу вибору супроводжуватися постійною перевіркою точності на незалежних частинах даних. Це дозволяє алгоритму не просто видаляти ознаки, а знайти ту конкретну кількість характеристик, при якій модель досягає максимальної узагальнюючої здатності, уникаючи перенавчання.
